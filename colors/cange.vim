...
"
"     git clone git://github.com/cange/vim-theme-cange.git
"     cd vim-theme-cange/
"
" and create a simlink to your Vim directory
"
"     ln -s colors/cange.vim ~/.vim/colors/
"
...
if g:cange_style == "dark"
  ...
  exe "hi! SpecialKey    " . s:bgNone        . s:fgGreyD       . s:none
  exe "hi! Title         " . s:bgNone        . s:fgBlueL       . s:bold
  " == Text Selection ==
  exe "hi! CursorIM      " . s:bgGreenL      . s:fgInvert      . s:none
  exe "hi! CursorColumn  " . s:bgRed         . s:fgNone        . s:none
  ...
  exe "hi! Folded        " . s:bgGreyD       . s:fgGreyL       . s:none
  exe "hi! FoldColumn    " . s:bgGreyD       . s:fgGreyL       . s:none
  exe "hi! VertSplit     " . s:bgGrey        . s:fgGrey        . s:none
  exe "hi! LineNr        " . s:bgGreyD       . s:fgGreyL       . s:none
  exe "hi! CursorLineNr  " . s:bgGrey        . s:fgGreyLr      . s:none
  ...
  exe "hi! Function      " . s:bgNone        . s:fgOrangeL     . s:bold
...
elseif g:cange_style == "light"
  ...
  exe "hi! SpecialKey    " . s:bgNone         . s:fgGreyLr     . s:none
  ...
  exe "hi! CursorLineNr  " . s:bgGreyLr       . s:fgGreyLst       . s:none
